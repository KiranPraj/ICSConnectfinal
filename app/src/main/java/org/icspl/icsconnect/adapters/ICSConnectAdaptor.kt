...
import org.icspl.icsconnect.activity.ICSConnect
...
class ICSConnectAdaptor(
    homescreen: Context,
    callback: ICSConnect, internal var array: List<HomescreenModel>) :
    RecyclerView.Adapter<ICSConnectAdaptor.Holder>() {
